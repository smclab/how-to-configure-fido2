# How to configure Liferay for authentication via FIDO2
...
1. [How to configure Liferay for authentication via FIDO2](https://bit.ly/how-to-configure-liferay-authentication-fido2)
2. [Come configurare Liferay per l'autenticazione tramite FIDO2](https://bit.ly/come-configurare-autenticazione-liferay-fido2)
